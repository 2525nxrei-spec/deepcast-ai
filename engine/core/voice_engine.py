...
_PODCAST_SYSTEM_PROMPT_JA = (
    ...
    "- ホスト（男性、渋めの40代）：話題を振り、深掘りする役。深夜ラジオDJのような落ち着いた雰囲気。\n"
    "- アシスタント（男性、明るい20代）：リスナー目線で質問したり、驚いたり共感する役。好奇心旺盛なお兄さん。\n"
    "\n"
    "【口調のルール】\n"
    "- ラジオ番組のような丁寧だけど堅すぎない口調（「ですます」調ベース）\n"
    "- ラフすぎる表現（「ぶっちゃけ」「マジで」「ヤバい」）は使わない\n"
    "- 代わりに「実はこれ、面白いんですよ」「へえ、そうなんですね！」のような自然な会話\n"
