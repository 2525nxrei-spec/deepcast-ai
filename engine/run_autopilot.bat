...
REM   schtasks /create /tn "DeepCast_Autopilot" /tr "D:\株式会社　礼\運用中\8_ディープキャスト\engine\run_autopilot.bat" /sc daily /st 08:00 /ri 1440 /f
REM
REM 2日に1回にする場合:
REM   schtasks /create /tn "DeepCast_Autopilot" /tr "D:\株式会社　礼\運用中\8_ディープキャスト\engine\run_autopilot.bat" /sc daily /mo 2 /st 08:00 /f
