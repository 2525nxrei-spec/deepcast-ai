...
(function () {
  ...
  // =========================================================
  // Keywords per category (AI/AGI/GPT etc. excluded — they appear in every episode on this podcast)
  ...
  function autoDetectCategory(ep) {
    ...
    for (var cat in CATEGORY_KEYWORDS) {
      CATEGORY_KEYWORDS[cat].forEach(function(kw) {
        ...
        // Tag match = 3 points (tags are intentionally chosen)
